...
public class GameController implements Initializable {
    ...
    void move_the_obstacles_back(MouseEvent event) {
        ...
        parallelTransition.setOnFinished(xyz -> Game.getHeroJump().play());
        ...
        if (weapon1_flag && num_taps%1==0){
            ...
            rocketWeaponView.setLayoutX(Game.getHeroView().getLayoutX());
            rocketWeaponView.setLayoutY(Game.getHeroView().getLayoutY()-40);
            anchor_pane.getChildren().add(rocketWeaponView);
            rocketWeaponView.setLayoutX(Game.getHeroView().getLayoutX()+20);
...
//        }
    ...
    public void change_to_result(){
        ...
        resultController.display(coins, score,stage );
    ...
    private TranslateTransition[] getTranslateTransitionsBackGround() {
        ...
        TranslateTransition translateObjects[]= {
                ...
                getTranslateTransitionBackGround(stick_wind_mill_3), getTranslateTransitionBackGround(Game.getWindmill_view()),
...
//    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        realHero = new Hero(Game.getHeroView());
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(10), e -> {
            ...
            if (realBoss.getPower()!= 0 && Game.getHeroView().getBoundsInParent().intersects(bossOrc.getBoundsInParent())) {
            ...
            for (ImageView i : coinsViews) {
                ...
                if (i.getImage()!=null && Game.getHeroView().getBoundsInParent().intersects(i.getBoundsInParent())) {
            ...
            if ( !realGame.isLost() && Game.getHeroView().getBoundsInParent().intersects(Game.getWindmill_view().getBoundsInParent())) {
            ...
            for (Rectangle i : valley_list) {
                ...
                if (!realGame.isLost() && Game.getHeroView().getBoundsInParent().intersects(i.getBoundsInParent())) {
            ...
            for (int i = 0; i< orcsViews.length; i++) {
                ...
                if (realOrcs[i].getPower()!= 0 && Game.getHeroView().getBoundsInParent().intersects(orcsViews[i].getBoundsInParent())) {
...
//            if(i.getBoundsInParent().intersects(Game.getHeroView().getBoundsInParent())){
//                System.out.println("collision Orc hit hero");
//            }
//        }
...
//        if(coin4.getBoundsInParent().intersects(orc1.getBoundsInParent())){
